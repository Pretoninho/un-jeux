...
> Dernière mise à jour : 2026-06-12 — v1.4
...
| --- | --- | --- | --- |
| 1 | Score Sharpe gameable (optimum dégénéré) — fonction-objectif du MVP | **ouvert, débloqué par §25** | **haute** |
...
| 4 | Levier : principe « parfois correct » acquis via `M` ; à vérifier au calibrage | partiel | basse |
...
> Prochaine tâche : **T2 — corriger le score** (pénalité de risque de queue ou Sharpe + seuil absolu).
